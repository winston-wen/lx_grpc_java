...
public final class LubanManagerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<lx.protogen.lbm.Lbm.CheckinRequest,
      lx.protogen.lbm.Lbm.CheckinResponse> getMpcCheckinAgreeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MpcCheckinAgree",
      requestType = lx.protogen.lbm.Lbm.CheckinRequest.class,
      responseType = lx.protogen.lbm.Lbm.CheckinResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<lx.protogen.lbm.Lbm.CheckinRequest,
      lx.protogen.lbm.Lbm.CheckinResponse> getMpcCheckinAgreeMethod() {
    io.grpc.MethodDescriptor<lx.protogen.lbm.Lbm.CheckinRequest, lx.protogen.lbm.Lbm.CheckinResponse> getMpcCheckinAgreeMethod;
    if ((getMpcCheckinAgreeMethod = LubanManagerGrpc.getMpcCheckinAgreeMethod) == null) {
      synchronized (LubanManagerGrpc.class) {
        if ((getMpcCheckinAgreeMethod = LubanManagerGrpc.getMpcCheckinAgreeMethod) == null) {
          LubanManagerGrpc.getMpcCheckinAgreeMethod = getMpcCheckinAgreeMethod =
              io.grpc.MethodDescriptor.<lx.protogen.lbm.Lbm.CheckinRequest, lx.protogen.lbm.Lbm.CheckinResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MpcCheckinAgree"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  lx.protogen.lbm.Lbm.CheckinRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  lx.protogen.lbm.Lbm.CheckinResponse.getDefaultInstance()))
              .setSchemaDescriptor(new LubanManagerMethodDescriptorSupplier("MpcCheckinAgree"))
              .build();
        }
      }
    }
    return getMpcCheckinAgreeMethod;
  }

  private static volatile io.grpc.MethodDescriptor<lx.protogen.lbm.Lbm.CheckinRequest,
      lx.protogen.lbm.Lbm.Void> getMpcCheckinDisagreeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MpcCheckinDisagree",
      requestType = lx.protogen.lbm.Lbm.CheckinRequest.class,
      responseType = lx.protogen.lbm.Lbm.Void.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<lx.protogen.lbm.Lbm.CheckinRequest,
      lx.protogen.lbm.Lbm.Void> getMpcCheckinDisagreeMethod() {
    io.grpc.MethodDescriptor<lx.protogen.lbm.Lbm.CheckinRequest, lx.protogen.lbm.Lbm.Void> getMpcCheckinDisagreeMethod;
    if ((getMpcCheckinDisagreeMethod = LubanManagerGrpc.getMpcCheckinDisagreeMethod) == null) {
      synchronized (LubanManagerGrpc.class) {
        if ((getMpcCheckinDisagreeMethod = LubanManagerGrpc.getMpcCheckinDisagreeMethod) == null) {
          LubanManagerGrpc.getMpcCheckinDisagreeMethod = getMpcCheckinDisagreeMethod =
              io.grpc.MethodDescriptor.<lx.protogen.lbm.Lbm.CheckinRequest, lx.protogen.lbm.Lbm.Void>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MpcCheckinDisagree"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  lx.protogen.lbm.Lbm.CheckinRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  lx.protogen.lbm.Lbm.Void.getDefaultInstance()))
              .setSchemaDescriptor(new LubanManagerMethodDescriptorSupplier("MpcCheckinDisagree"))
              .build();
        }
      }
    }
    return getMpcCheckinDisagreeMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void mpcCheckinAgree(lx.protogen.lbm.Lbm.CheckinRequest request,
        io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.CheckinResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMpcCheckinAgreeMethod(), responseObserver);
    }

    /**
     */
    default void mpcCheckinDisagree(lx.protogen.lbm.Lbm.CheckinRequest request,
        io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.Void> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMpcCheckinDisagreeMethod(), responseObserver);
    }
  ...
  public static final class LubanManagerStub
    ...
    /**
     */
    public void mpcCheckinAgree(lx.protogen.lbm.Lbm.CheckinRequest request,
        io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.CheckinResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getMpcCheckinAgreeMethod(), getCallOptions()), request, responseObserver);
    }

    /**
     */
    public void mpcCheckinDisagree(lx.protogen.lbm.Lbm.CheckinRequest request,
        io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.Void> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getMpcCheckinDisagreeMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class LubanManagerBlockingStub
    ...
    /**
     */
    public lx.protogen.lbm.Lbm.CheckinResponse mpcCheckinAgree(lx.protogen.lbm.Lbm.CheckinRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getMpcCheckinAgreeMethod(), getCallOptions(), request);
    }

    /**
     */
    public lx.protogen.lbm.Lbm.Void mpcCheckinDisagree(lx.protogen.lbm.Lbm.CheckinRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getMpcCheckinDisagreeMethod(), getCallOptions(), request);
    }
  ...
  public static final class LubanManagerFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<lx.protogen.lbm.Lbm.CheckinResponse> mpcCheckinAgree(
        lx.protogen.lbm.Lbm.CheckinRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getMpcCheckinAgreeMethod(), getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<lx.protogen.lbm.Lbm.Void> mpcCheckinDisagree(
        lx.protogen.lbm.Lbm.CheckinRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getMpcCheckinDisagreeMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_MPC_CHECKIN_AGREE = 8;
  private static final int METHODID_MPC_CHECKIN_DISAGREE = 9;
      ...
      switch (methodId) {
        ...
        case METHODID_MPC_TERMINATE_SIGN:
          serviceImpl.mpcTerminateSign((lx.protogen.lbm.Lbm.SignTermination) request,
              (io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.Void>) responseObserver);
          break;
        case METHODID_MPC_CHECKIN_AGREE:
          serviceImpl.mpcCheckinAgree((lx.protogen.lbm.Lbm.CheckinRequest) request,
              (io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.CheckinResponse>) responseObserver);
          break;
        case METHODID_MPC_CHECKIN_DISAGREE:
          serviceImpl.mpcCheckinDisagree((lx.protogen.lbm.Lbm.CheckinRequest) request,
              (io.grpc.stub.StreamObserver<lx.protogen.lbm.Lbm.Void>) responseObserver);
          break;
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          getMpcCheckinAgreeMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              lx.protogen.lbm.Lbm.CheckinRequest,
              lx.protogen.lbm.Lbm.CheckinResponse>(
                service, METHODID_MPC_CHECKIN_AGREE)))
        .addMethod(
          getMpcCheckinDisagreeMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              lx.protogen.lbm.Lbm.CheckinRequest,
              lx.protogen.lbm.Lbm.Void>(
                service, METHODID_MPC_CHECKIN_DISAGREE)))
        .addMethod(
      ...
      synchronized (LubanManagerGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getMpcCheckinAgreeMethod())
              .addMethod(getMpcCheckinDisagreeMethod())
